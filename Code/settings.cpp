...
void drawSettings() {
  drawBackground();
  tft.pushImage(1, 46, 152, 184, image_byte_happy_copy_1_pixels, TFT_BLACK);
...
void drawLocktime() {
  drawBackground();
  tft.pushImage(7, 31, 192, 208, image_Tamagotchi_Lockbox_UI_Image_Jul_27_2026__2__copy_1_pixels, TFT_BLACK);
...
void drawSystem() {
  drawBackground();
  tft.pushImage(10, 62, 136, 184, image_byte_idle_copy_1_pixels, TFT_BLACK);
